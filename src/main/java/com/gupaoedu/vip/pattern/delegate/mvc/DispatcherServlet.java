...
import com.gupaoedu.vip.pattern.delegate.mvc.controller.OrderController;
import com.gupaoedu.vip.pattern.delegate.mvc.controller.SystemController;
...
public class DispatcherServlet extends HttpServlet {
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) {
        ...
        Object object = null;
        try {
            object = handler.getMethod().invoke(handler.getController(), null);
            try {
